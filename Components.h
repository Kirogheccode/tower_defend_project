...
struct CMovement {
	...
	vector<Vector2f> starting_pos = {	// Vị trí bắt đầu cho từng map
		{1165.f, 1580.f}, { -500.f, 500.f }, { 1252.f, 1575.f }, { 700.f, 1575.f }
	};
	...
	vector<vector<vector<Vector2f>>> paths = {
		...
		{ // Map 4
			{ {700.f,505.f}, {200.f,505.f}, {200.f,245.f}, {1320.f,245.f}, {1320.f,110.f} },													   // path 1
			{ {700.f,535.f}, {880.f,435.f}, {880.f,245.f}, {1320.f,245.f}, {1320.f,110.f} },													   // path 2
			{ {700.f,885.f}, {1230.f,885.f}, {1420.f,725.f}, {1420.f,430.f}, {1245.f,430.f}, {1245.f,245.f}, {1320.f, 245.f}, {1320.f, 110.f}},    // path 3
			{ {700.f,745.f}, {900.f,745.f}, {1030.f,650.f}, {1170.f,650.f}, {1245.f,600.f}, {1245.f,245.f}, {1320.f, 245.f}, {1320.f, 110.f}}      // path 4
		}
	};
